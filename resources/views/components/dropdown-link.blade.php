...
@php
    $classes = $active
                ? 'block w-full px-4 py-2 text-start text-sm leading-5 text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-800 focus:outline-none focus:bg-gray-200 dark:focus:bg-gray-700 transition duration-150 ease-in-out'
